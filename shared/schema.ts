...
export const returnStatusEnum = pgEnum("return_status", ["requested", "approved", "rejected", "in_transit", "inspection", "pickup_scheduled", "picked_up", "received", "inspected", "completed", "cancelled"]);
