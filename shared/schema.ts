...
export const returnStatusEnum = pgEnum("return_status", ["requested", "approved", "rejected", "pickup_scheduled", "picked_up", "in_transit", "received", "inspection", "inspected", "completed", "cancelled"]);
